                ...
                <div class="space-y-6 sm:space-y-5">
                    ...
                    <div class="sm:pt-5">
                        <div class="flex justify-end gap-x-3">
                            ...
                            <x-button type="submit" styles="indigo" class="focus-visible:outline--400 inline-flex justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">
                                Create</x-button>
                        </div>
                    </div>
                </div>
