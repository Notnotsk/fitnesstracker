    ...
    <x-container>
        <div class="space-y-12 sm:space-y-16">
            ...
            <form action="/workouts/{{ $workout->id }}" method="post">
                ...
                <div>
                    <div
                        class="pb-12 space-y-8 border-gray-900/10 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:pb-0">
                        ...
                        <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                            ...
                            <div class="mt-2 sm:col-span-2 sm:mt-0">
                                <x-input type="text" name="name" id="name" autocomplete="name"
                                    :value="old('name', $workout->name)" placeholder="Routine/Week/Day" />
                            </div>
                        </div>
                        <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
